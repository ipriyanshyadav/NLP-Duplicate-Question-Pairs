...
def load_models():
    try:
        ...
        w2v_model = gensim.models.Word2Vec.load('models/word2vec_model.model')
        
        return classifier, w2v_model
    except FileNotFoundError:
        st.error("Models not found! Please run save_models.py first to train and save the models.")
        st.stop()
